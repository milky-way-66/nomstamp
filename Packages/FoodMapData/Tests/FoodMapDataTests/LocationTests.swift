...
struct LocationFixResolverTests {
    ...
    /// TC-1-22 — a fix we cannot trust is not a fix.
    @Test("A coarse or invalid fix is discarded and reported as no coordinate")
    func TC_1_22_coarseFixIsDiscarded() async {
        ...
        // A cell-tower fix and an invalid one arrive; neither may become the answer.
        Task {
